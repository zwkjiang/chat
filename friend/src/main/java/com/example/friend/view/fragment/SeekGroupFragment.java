...
import com.example.friend.databinding.FragmentSeekgroupBinding;
import com.example.friend.viewmodel.GoodViewModel;

public class SeekGroupFragment extends BaseFragment<FragmentSeekgroupBinding, GoodViewModel> {
    @Override
    ...
    protected int getLayoutID() {
        return R.layout.fragment_seekgroup;
    }
}
